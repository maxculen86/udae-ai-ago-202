...
var styles$Y = require('@material-ui/core/styles');
...
var Root = styles$Y.withStyles(styles, {
  name: 'Root'
})(LayoutBase);
...
var DEFAULT_PALETTE = [colors.red, colors.pink, colors.purple, colors.deepPurple, colors.indigo, colors.blue, colors.lightBlue, colors.cyan, colors.teal, colors.green, colors.lightGreen, colors.lime, colors.yellow, colors.amber, colors.orange, colors.deepOrange];
...
var getBrightBorder = function getBrightBorder(theme) {
  return "1px solid ".concat(theme.palette.type === 'light' ? colorManipulator.lighten(colorManipulator.fade(theme.palette.divider, 1), 0.72) : colorManipulator.darken(colorManipulator.fade(theme.palette.divider, 1), 0.5));
};
...
var useStyles = styles$Y.makeStyles(function (theme) {
  return {
    container: {
      overflowY: 'auto',
      position: 'relative',
...
var MainLayout = React.memo(function (_ref2) {
  ...
  var TimeScale = _ref2.timeScaleComponent,
      ...
      restProps = _objectWithoutProperties(_ref2, ["timeScaleComponent", "dayScaleComponent", "timeTableComponent", "dayScaleEmptyCellComponent", "groupingPanelComponent", "groupingPanelSize", "setScrollingStrategy", "className"]);
  ...
  return React.createElement("div", _extends({
    ...
    className: classNames(classes.container, className),
    onScroll: setBorders
  }, restProps), React.createElement("div", null, React.createElement("div", {
    ref: layoutHeaderRef,
  ...
  }, renderLeftPanel && React.createElement("div", {
  ...
  }, React.createElement(DayScaleEmptyCell, null)), React.createElement("div", null, React.createElement(DayScale, null)))), React.createElement("div", {
  ...
  }, React.createElement(GroupingPanel, null), renderTimeScale && React.createElement(TimeScale, null)), React.createElement("div", {
...
var DayScaleEmptyCell = styles$Y.withStyles(styles$1, {
...
var Container = styles$Y.withStyles(styles$2, {
...
var TicksLayoutBase = function TicksLayoutBase(_ref) {
  ...
  return React.createElement(Table$2, _extends({}, restProps, {
    className: classNames(classes.table, className)
  }), React.createElement(TableBody, null, cellsData.map(function (_ref2, index) {
    var _ref3 = _slicedToArray(_ref2, 1),
        firstDay = _ref3[0];

    return React.createElement(React.Fragment, {
      key: index.toString()
    }, index % groupHeight === 0 && includeAllDayCell && React.createElement(Row, {
...
var TicksLayout = styles$Y.withStyles(styles$3, {
  name: 'TicksLayout'
})(TicksLayoutBase);

var useStyles$1 = styles$Y.makeStyles(function (theme) {
  return {
    timeScaleContainer: {
...
var Layout = function Layout(_ref2) {
  var Label = _ref2.labelComponent,
      ...
      height = _ref2.height,
      className = _ref2.className,
      restProps = _objectWithoutProperties(_ref2, ["labelComponent", "rowComponent", "tickCellComponent", "allDayTitleComponent", "cellsData", "formatDate", "groupOrientation", "groups", "showAllDayTitle", "height", "className"]);
  ...
  return React.createElement("div", _extends({
  ...
  }, restProps), React.createElement(Table$2, {
    className: classes.timeScaleContainer
  }, React.createElement(TableBody, null, dxSchedulerCore.getLabelsForAllGroups(cellsData, groups, groupOrientation).map(function (groupedLabels, groupIndex) {
    var _classNames;
    ...
    return React.createElement(TableRow, {
      ...
      className: classNames((_classNames = {}, _defineProperty(_classNames, classes.cell, true), _defineProperty(_classNames, classes.verticalCell, groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION), _classNames))
    }, React.createElement(AllDayTitle, {
      fixedHeight: true
...
var Label = styles$Y.withStyles(styles$4, {
  name: 'Label'
})(LabelBase);
...
var TickCell = styles$Y.withStyles(styles$5, {
  name: 'TickCell'
})(TickCellBase);

var _table;
var useStyles$2 = styles$Y.makeStyles({
  table: (_table = {
    tableLayout: 'fixed',
...
var Table = React.forwardRef(function (_ref, ref) {
  ...
  return React.createElement(Table$2, _extends({
    ref: ref,
    className: classNames(classes.table, className)
  }, restProps), React.createElement(TableBody, null, children));
});
...
var Layout$1 = React.memo(function (_ref) {
  var setCellElementsMeta = _ref.setCellElementsMeta,
      cellsNumber = _ref.cellsNumber,
      children = _ref.children,
      restProps = _objectWithoutProperties(_ref, ["setCellElementsMeta", "cellsNumber", "children"]);
...
var Layout$2 = React.memo(function (_ref) {
  var setCellElementsMeta = _ref.setCellElementsMeta,
  ...
  return React.createElement(Layout$1, _extends({
    ...
    return React.createElement(React.Fragment, {
      key: groupIndex.toString()
    }, allDayCellsData && React.createElement(AllDayRow, null, allDayCellsData[groupIndex].map(function (_ref2) {
...
var useStyles$3 = styles$Y.makeStyles(function (theme) {
  return {
    cell: {
      position: 'relative',
      height: theme.spacing(SPACING_CELL_HEIGHT[dxSchedulerCore.VIEW_TYPES.WEEK]),
    ...
    shadedCell: {
      backgroundColor: colorManipulator.fade(theme.palette.action.disabledBackground, 0.04),
      '&:hover': {
...
var Cell = function Cell(_ref2) {
  ...
  return React.createElement(TableCell, _extends({
    tabIndex: 0,
    className: classNames((_classNames = {}, _defineProperty(_classNames, classes.cell, true), _defineProperty(_classNames, classes.shadedCell, isShaded && !isNow), _defineProperty(_classNames, classes.brightRightBorder, (endOfGroup || hasRightBorder) && groupOrientation === dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION), _defineProperty(_classNames, classes.brightBorderBottom, endOfGroup && groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION), _classNames), className)
  }, restProps), isNow && isShaded && React.createElement("div", {
    className: classes.shadedPart
  }), isNow && React.createElement(CurrentTimeIndicator, {
...
var Layout$3 = React.memo(function (_ref) {
  var Cell = _ref.cellComponent,
      Row = _ref.rowComponent,
  ...
  return React.createElement(Table, _extends({
    cellsNumber: cellsData[0].length
  }, restProps), !groupedByDate && React.createElement(GroupingPanel, null), React.createElement(Row, null, dxSchedulerCore.getDayScaleCells(cellsData, groupedByDate).map(function (_ref2) {
    var startDate = _ref2.startDate,
        endDate = _ref2.endDate,
        today = _ref2.today,
        key = _ref2.key,
  ...
  })), groupedByDate && React.createElement(GroupingPanel, null));
});
Layout$3.propTypes = {
  cellsData: PropTypes.arrayOf(Array).isRequired,
  cellComponent: PropTypes.oneOfType([PropTypes.func, PropTypes.object]).isRequired,
...
var Cell$1 = styles$Y.withStyles(styles$6, {
  name: 'Cell'
})(CellBase);
...
var Layout$4 = React.memo(function (_ref) {
  var setCellElementsMeta = _ref.setCellElementsMeta,
...
var CellBase$1 = React.memo(function (_ref) {
  ...
  return React.createElement(TableCell, _extends({
    tabIndex: 0,
    className: classNames((_classNames = {}, _defineProperty(_classNames, classes.cell, true), _defineProperty(_classNames, classes.shadedCell, isShaded), _defineProperty(_classNames, classes.brightRightBorder, (endOfGroup || hasRightBorder) && groupOrientation === dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION), _defineProperty(_classNames, classes.brightBorderBottom, endOfGroup && groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION), _classNames), className)
  }, restProps), React.createElement("div", {
...
var Cell$2 = styles$Y.withStyles(styles$7, {
  name: 'Cell'
})(CellBase$1);
...
var Cell$3 = styles$Y.withStyles(styles$8, {
  name: 'Cell'
})(CellBase$2);
...
var HorizontalAppointment = styles$Y.withStyles(styles$9, {
...
var VerticalAppointmentBase = function VerticalAppointmentBase(_ref2) {
  ...
  }, addCommaAndSpaceToString(data.title)), React.createElement("div", {
...
var VerticalAppointment = styles$Y.withStyles(styles$a, {
...
var useStyles$4 = styles$Y.makeStyles(function (_ref) {
  var palette = _ref.palette,
...
var SplitIndicator = styles$Y.withStyles(styles$b, {
  name: 'AppointmentsContainer'
})(SplitIndicatorBase);
...
var Toolbar = styles$Y.withStyles(styles$c, {
  name: 'Toolbar'
})(ToolbarBase);
...
var FlexibleSpace = styles$Y.withStyles(styles$d, {
  name: 'FlexibleSpace'
})(FlexibleSpaceBase);
...
var Root$1 = styles$Y.withStyles(styles$e)(RootBase, {
  name: 'Root'
});
...
var OpenButton = styles$Y.withStyles(styles$f, {
  name: 'OpenButton'
})(OpenButtonBase);
...
var NavigationButton = styles$Y.withStyles(styles$g, {
...
var Table$1 = styles$Y.withStyles(styles$h, {
  name: 'Table'
})(TableBase);
...
var Cell$4 = styles$Y.withStyles(styles$i, {
  name: 'Cell'
})(CellBase$3);
...
var HeaderCell = styles$Y.withStyles(styles$j, {
  name: 'HeaderCell'
})(HeaderCellBase);
...
var Navigator = styles$Y.withStyles(styles$k, {
  name: 'Navigator'
})(NavigatorBase);
...
var Text = styles$Y.withStyles(styles$l, {
  name: 'Text'
})(TextBase);
...
var Layout$5 = styles$Y.withStyles(styles$m, {
  name: 'Layout'
})(LayoutBase$1);
...
var Header = styles$Y.withStyles(styles$n, {
  name: 'Header'
})(HeaderBase);

var useStyles$5 = styles$Y.makeStyles(function (_ref) {
  var spacing = _ref.spacing,
      palette = _ref.palette,
      typography = _ref.typography;
  return {
...
var OutlinedSelect = styles$Y.withStyles(styles$o)(OutlinedSelectBase, {
  name: 'OutlinedSelect'
});
...
var Switcher = styles$Y.withStyles(styles$p)(SwitcherBase, {
  name: 'Switcher'
});
...
var LayoutBase$2 = React.memo(function (_ref) {
  var setCellElementsMeta = _ref.setCellElementsMeta,
      cellsData = _ref.cellsData,
      classes = _ref.classes,
      className = _ref.className,
      ...
      Row = _ref.rowComponent,
      formatDate = _ref.formatDate,
      restProps = _objectWithoutProperties(_ref, ["setCellElementsMeta", "cellsData", "classes", "className", "cellComponent", "rowComponent", "formatDate"]);
  ...
  return React.createElement(Table$2, _extends({
    ref: tableRef,
    className: classNames(classes.table, className)
  }, restProps), React.createElement(TableBody, null, React.createElement(Row, null, cellsData.map(function (_ref2) {
    var startDate = _ref2.startDate,
        endDate = _ref2.endDate,
        endOfGroup = _ref2.endOfGroup,
        groupingInfo = _ref2.groupingInfo;
...
var Layout$6 = styles$Y.withStyles(styles$q, {
  name: 'Layout'
})(LayoutBase$2);
...
var CellBase$4 = function CellBase(_ref) {
  ...
  return React.createElement(TableCell, _extends({
    tabIndex: 0,
    className: classNames((_classNames = {}, _defineProperty(_classNames, classes.cell, true), _defineProperty(_classNames, classes.brightRightBorder, groupOrientation === dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION && (endOfGroup || hasRightBorder)), _classNames), className)
  }, restProps), children);
};
...
var Cell$5 = styles$Y.withStyles(styles$r, {
  name: 'Cell'
})(CellBase$4);
...
var TitleCell = styles$Y.withStyles(styles$s, {
  name: 'TitleCell'
})(TitleCellBase);
...
var Container$1 = styles$Y.withStyles(styles$t, {
...
var Layout$7 = styles$Y.withStyles(styles$u)(LayoutBase$3, {
  name: 'Layout'
});
...
var TextEditor = styles$Y.withStyles(styles$v)(TextEditorBase, {
  name: 'TextEditor'
});
...
var LayoutBase$4 = function LayoutBase(_ref2) {
  ...
  return React.createElement("div", _extends({
    ...
    return React.createElement(React.Fragment, {
      ...
      type: dxSchedulerCore.TITLE,
      className: classes.labelWithMargins
    }), React.createElement(ResourceEditor, {
      readOnly: readOnly,
      resource: resource,
      appointmentResources: appointmentResources,
...
var Layout$8 = styles$Y.withStyles(styles$w)(LayoutBase$4, {
  name: 'BasicLayout'
});
...
var Layout$9 = styles$Y.withStyles(styles$x)(LayoutBase$5, {
  name: 'Layout'
});
...
var SaveButton = styles$Y.withStyles(styles$y)(SaveButtonBase, {
  name: 'SaveButton'
});
...
var DeleteButton = styles$Y.withStyles(styles$z)(DeleteButtonBase, {
  name: 'DeleteButton'
});
...
var CancelButton = styles$Y.withStyles(styles$A)(CancelButtonBase, {
  name: 'CancelButton'
});
...
var Overlay$1 = styles$Y.withStyles(styles$B)(OverlayBase, {
  name: 'Overlay'
});
...
var DateEditor = styles$Y.withStyles(styles$C)(DateEditorBase, {
  name: 'DateEditor'
});
...
var Label$1 = styles$Y.withStyles(styles$D)(LabelBase$1, {
  name: 'Label'
});
...
var BooleanEditor = styles$Y.withStyles(styles$E)(BooleanEditorBase, {
  name: 'BooleanEditor'
});
...
var FilledSelect = styles$Y.withStyles(styles$F)(FilledSelectBase, {
  name: 'FilledSelect'
});
...
var IntervalEditor = styles$Y.withStyles(styles$G)(IntervalEditorBase, {
  name: 'IntervalEditor'
});
...
var Weekly = styles$Y.withStyles(styles$H)(WeeklyBase, {
  name: 'Weekly'
});
...
var Monthly = styles$Y.withStyles(styles$I)(MonthlyBase, {
  name: 'Monthly'
});
...
var Yearly = styles$Y.withStyles(styles$J)(YearlyBase, {
  name: 'Yearly'
});
...
var Layout$a = styles$Y.withStyles(styles$K)(LayoutBase$6, {
...
var EndRepeatEditor = styles$Y.withStyles(styles$L)(EndRepeatEditorBase, {
...
var MonthlyEditor = styles$Y.withStyles(styles$M)(MonthlyEditorBase, {
  name: 'MonthlyEditor'
});
...
var ChangeMonthEditor = styles$Y.withStyles(styles$N)(ChangeMonthEditorBase, {
...
var ChangeWeekNumberEditor = styles$Y.withStyles(styles$O)(ChangeWeekNumberEditorBase, {
...
var WeeklyRecurrenceSelector = styles$Y.withStyles(styles$P)(WeeklyRecurrenceSelectorBase, {
...
var OverlayContainer = styles$Y.withStyles(styles$Q, {
...
var useStyles$6 = styles$Y.makeStyles(function (_ref) {
  var spacing = _ref.spacing;
  return {
    select: {
      padding: spacing(1)
...
var ResourceEditor = React.memo(function (_ref2) {
  ...
  return React.createElement(Select$1, _extends({
    ...
    renderValue: function renderValue(selected) {
      return resource.allowMultiple ? React.createElement("div", {
...
var draftStyles = styles$Y.makeStyles(function (theme) {
  return {
    appointment: {
...
var sourceStyles = styles$Y.makeStyles({
  appointment: {
    opacity: 0.5
  }
});
var DraftAppointment = function DraftAppointment(_ref) {
  ...
  return React.createElement(AppointmentBase, _extends({
...
var Container$2 = styles$Y.withStyles(styles$R, {
...
var Resize = styles$Y.withStyles(styles$S, {
  name: 'Resize'
})(ResizeBase);
...
var TodayButton = styles$Y.withStyles(styles$T)(TodayButtonBase, {
  name: 'TodayButton'
});
...
var Overlay$2 = styles$Y.withStyles(styles$U, {
  name: 'Overlay'
})(OverlayBase$1);
...
var LayoutBase$7 = React.memo(function (_ref3) {
  ...
  }, getMessage(isDeleting ? 'menuDeletingTitle' : 'menuEditingTitle')), React.createElement(DialogContent, null, React.createElement(RadioGroup$1, {
    value: currentValue,
    onChange: handleChange
...
var Layout$b = styles$Y.withStyles(styles$V, {
  name: 'Layout'
})(LayoutBase$7);
...
var LayoutBase$8 = React.memo(function (_ref3) {
  var Button = _ref3.buttonComponent,
...
var Layout$c = styles$Y.withStyles(styles$W, {
  name: 'Layout'
})(LayoutBase$8);
...
var useStyles$7 = styles$Y.makeStyles(function (theme) {
  return {
    line: {
      height: '2px',
      width: '100%',
...
var Indicator = function Indicator(_ref2) {
  ...
  return React.createElement("div", restProps, React.createElement("div", {
...
var Resources = function Resources(_ref) {
  var data = _ref.data,
      ...
      palette = _ref.palette;
  return React.createElement(dxReactScheduler.Resources, {
    data: data,
...
var HorizontalLayout = function HorizontalLayout(_ref) {
  ...
  return React.createElement(React.Fragment, null, groups.map(function (groupRow, rowIndex) {
...
var VerticalLayoutBase = function VerticalLayoutBase(_ref) {
  ...
  }, restProps), React.createElement(TableBody, null, dxSchedulerCore.getGroupsLastRow(groups).map(function (_, groupIndex) {
    return React.createElement(Row, {
      key: groupIndex.toString()
...
var VerticalLayout = styles$Y.withStyles(styles$X, {
  name: 'VerticalLayout'
})(VerticalLayoutBase);

var useStyles$8 = styles$Y.makeStyles(function (theme) {
  return {
    cell: {
      userSelect: 'none',
      padding: 0,
...
var Cell$6 = React.memo(function (_ref7) {
  var _classNames, _classNames2;
  ...
  return React.createElement(TableCell, _extends({
    className: classNames((_classNames = {}, _defineProperty(_classNames, classes.cell, true), _defineProperty(_classNames, classes.horizontalCell, groupOrientation === dxSchedulerCore.HORIZONTAL_GROUP_ORIENTATION), _defineProperty(_classNames, classes.verticalCell, groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION), _defineProperty(_classNames, classes.groupedByDate, groupedByDate && groupOrientation !== dxSchedulerCore.VERTICAL_GROUP_ORIENTATION), _classNames), className),
    colSpan: colSpan,
    rowSpan: rowSpan
  }, restProps), React.createElement("div", {
    className: classes.textContainer
  }, React.createElement("div", {
    className: classNames((_classNames2 = {}, _defineProperty(_classNames2, classes.text, true), _defineProperty(_classNames2, classes.verticalCellText, groupOrientation === dxSchedulerCore.VERTICAL_GROUP_ORIENTATION), _classNames2))
  }, group.text, children)));
});
